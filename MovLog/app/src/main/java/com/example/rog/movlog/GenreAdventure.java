 ...
 */
public class GenreAdventure extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MovieView = inflater.inflate(R.layout.fragment_genre_adventure, container, false);
    ...
    public void firebaseSearch(String searchText){
        ...
        FirebaseRecyclerAdapter<Model, GenreAdventure.MovieViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Model, GenreAdventure.MovieViewHolder>(option) {
                    @Override
                    protected void onBindViewHolder(@NonNull GenreAdventure.MovieViewHolder holder, final int position, @NonNull Model model) {
                    ...
                    @NonNull
                    @Override
                    public GenreAdventure.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.movielist, viewGroup, false);
                        GenreAdventure.MovieViewHolder viewHolder = new GenreAdventure.MovieViewHolder(view);
                        return viewHolder;                    }
                };
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Model, GenreAdventure.MovieViewHolder> adapter
                = new FirebaseRecyclerAdapter<Model, GenreAdventure.MovieViewHolder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull final GenreAdventure.MovieViewHolder holder, final int position, @NonNull Model model)
            {
                String title = model.getTitle();
                String genre = model.getGenre();
                String image = model.getImage();
                ...
                .setItems(sortOptions, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0)
                        {
                            ...
                            getFragmentManager()
                                    .beginTransaction()
                                    .detach(GenreAdventure.this)
                                    .attach(GenreAdventure.this)
                                    .commit();
                        }
                        else if (which==1)
                        {
