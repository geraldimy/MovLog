 ...
 */
public class GenreRomantic extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MovieView = inflater.inflate(R.layout.fragment_genre_romantic, container, false);
    ...
    public void firebaseSearch(String searchText){
        ...
        FirebaseRecyclerAdapter<Model, GenreRomantic.MovieViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Model, GenreRomantic.MovieViewHolder>(option) {
                    @Override
                    protected void onBindViewHolder(@NonNull GenreRomantic.MovieViewHolder holder, final int position, @NonNull Model model) {
                    ...
                    @NonNull
                    @Override
                    public GenreRomantic.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.movielist, viewGroup, false);
                        GenreRomantic.MovieViewHolder viewHolder = new GenreRomantic.MovieViewHolder(view);
                        return viewHolder;                    }
                };
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Model, GenreRomantic.MovieViewHolder> adapter
                = new FirebaseRecyclerAdapter<Model, GenreRomantic.MovieViewHolder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull final GenreRomantic.MovieViewHolder holder, final int position, @NonNull Model model)
            {
                String title = model.getTitle();
                String genre = model.getGenre();
                String image = model.getImage();
                ...
                .setItems(sortOptions, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0)
                        {
                            ...
                            getFragmentManager()
                                    .beginTransaction()
                                    .detach(GenreRomantic.this)
                                    .attach(GenreRomantic.this)
                                    .commit();
                        }
                        else if (which==1)
                        {
