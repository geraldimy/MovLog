 ...
 */
public class GenreMystery extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MovieView = inflater.inflate(R.layout.fragment_genre_mystery, container, false);
    ...
    public void firebaseSearch(String searchText){
        ...
        FirebaseRecyclerAdapter<Model, GenreMystery.MovieViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Model, GenreMystery.MovieViewHolder>(option) {
                    @Override
                    protected void onBindViewHolder(@NonNull GenreMystery.MovieViewHolder holder, final int position, @NonNull Model model) {
                    ...
                    @NonNull
                    @Override
                    public GenreMystery.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.movielist, viewGroup, false);
                        GenreMystery.MovieViewHolder viewHolder = new GenreMystery.MovieViewHolder(view);
                        return viewHolder;                    }
                };
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Model, GenreMystery.MovieViewHolder> adapter
                = new FirebaseRecyclerAdapter<Model, GenreMystery.MovieViewHolder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull final GenreMystery.MovieViewHolder holder, final int position, @NonNull Model model)
            {
                String title = model.getTitle();
                String genre = model.getGenre();
                String image = model.getImage();
                ...
                .setItems(sortOptions, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0)
                        {
                            ...
                            getFragmentManager()
                                    .beginTransaction()
                                    .detach(GenreMystery.this)
                                    .attach(GenreMystery.this)
                                    .commit();
                        }
                        else if (which==1)
                        {
