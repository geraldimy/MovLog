...
import com.example.rog.movlog.NowShowing;
import com.example.rog.movlog.Model;
import com.example.rog.movlog.R;
 ...
 */
public class GenreAction extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MovieView = inflater.inflate(R.layout.fragment_genre_action, container, false);
    ...
    public void firebaseSearch(String searchText){
        ...
        FirebaseRecyclerAdapter<Model, GenreAction.MovieViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Model, GenreAction.MovieViewHolder>(option) {
                    @Override
                    protected void onBindViewHolder(@NonNull GenreAction.MovieViewHolder holder, final int position, @NonNull Model model) {
                    ...
                    @NonNull
                    @Override
                    public GenreAction.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.movielist, viewGroup, false);
                        GenreAction.MovieViewHolder viewHolder = new GenreAction.MovieViewHolder(view);
                        return viewHolder;                    }
                };
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Model, GenreAction.MovieViewHolder> adapter
                = new FirebaseRecyclerAdapter<Model, GenreAction.MovieViewHolder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull final GenreAction.MovieViewHolder holder, final int position, @NonNull Model model)
            {
                String title = model.getTitle();
                String genre = model.getGenre();
                String image = model.getImage();
                ...
                .setItems(sortOptions, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0)
                        {
                            ...
                            getFragmentManager()
                                    .beginTransaction()
                                    .detach(GenreAction.this)
                                    .attach(GenreAction.this)
                                    .commit();
                        }
                        else if (which==1)
                        {
