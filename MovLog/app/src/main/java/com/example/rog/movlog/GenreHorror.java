 ...
 */
public class GenreHorror extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MovieView = inflater.inflate(R.layout.fragment_genre_horror , container, false);
    ...
    public void firebaseSearch(String searchText){
        ...
        FirebaseRecyclerAdapter<Model, GenreHorror.MovieViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Model, GenreHorror.MovieViewHolder>(option) {
                    @Override
                    protected void onBindViewHolder(@NonNull GenreHorror.MovieViewHolder holder, final int position, @NonNull Model model) {
                    ...
                    @NonNull
                    @Override
                    public GenreHorror.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.movielist, viewGroup, false);
                        GenreHorror.MovieViewHolder viewHolder = new GenreHorror.MovieViewHolder(view);
                        return viewHolder;                    }
                };
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Model, GenreHorror.MovieViewHolder> adapter
                = new FirebaseRecyclerAdapter<Model, GenreHorror.MovieViewHolder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull final GenreHorror.MovieViewHolder holder, final int position, @NonNull Model model)
            {
                String title = model.getTitle();
                String genre = model.getGenre();
                String image = model.getImage();
                ...
                .setItems(sortOptions, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0)
                        {
                            ...
                            getFragmentManager()
                                    .beginTransaction()
                                    .detach(GenreHorror.this)
                                    .attach(GenreHorror.this)
                                    .commit();
                        }
                        else if (which==1)
                        {
