 ...
 */
public class GenreFantasy extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MovieView = inflater.inflate(R.layout.fragment_genre_fantasy, container, false);
    ...
    public void firebaseSearch(String searchText){
        ...
        FirebaseRecyclerAdapter<Model, GenreFantasy.MovieViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Model, GenreFantasy.MovieViewHolder>(option) {
                    @Override
                    protected void onBindViewHolder(@NonNull GenreFantasy.MovieViewHolder holder, final int position, @NonNull Model model) {
                    ...
                    @NonNull
                    @Override
                    public GenreFantasy.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.movielist, viewGroup, false);
                        GenreFantasy.MovieViewHolder viewHolder = new GenreFantasy.MovieViewHolder(view);
                        return viewHolder;                    }
                };
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Model, GenreFantasy.MovieViewHolder> adapter
                = new FirebaseRecyclerAdapter<Model, GenreFantasy.MovieViewHolder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull final GenreFantasy.MovieViewHolder holder, final int position, @NonNull Model model)
            {
                String title = model.getTitle();
                String genre = model.getGenre();
                String image = model.getImage();
                ...
                .setItems(sortOptions, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which==0)
                        {
                            ...
                            getFragmentManager()
                                    .beginTransaction()
                                    .detach(GenreFantasy.this)
                                    .attach(GenreFantasy.this)
                                    .commit();
                        }
                        else if (which==1)
                        {
