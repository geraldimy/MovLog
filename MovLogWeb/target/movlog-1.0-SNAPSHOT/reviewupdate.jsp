                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <form id="update_entry">
                                        <div class="card-body card-block">
                                         ...
                                         <div class="row form-group">
                                        		...
                                        		<input type="hidden" id="url_lama" name="url_lama" class="form-control" placeholder="url">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                <input type="file" value="upload" id="uploadButton2" />
                                                <input type="hidden" id="url_lama2" name="url_lama2" class="form-control" placeholder="url">
                                  ...
                                  `         &nbsp  <div class="form-group">
                                    ...
                                    <button class="btn btn-md btn-primary">Update Review</button>                                            
                                    </div>
                                    </div>
                                </form>
                                </div>
          ...
          uploadTask2.snapshot.ref.getDownloadURL().then( 
           ...
           $('[name="link2"]').val(downloadURL)
            ...
            if (IdF) {
                ...
                var Movie = firebase.database().ref('Movie').child(IdF);

                Movie.once('value', function (r) { // once = just this once, no need to actively watch the changes
                    var movie = r.val();
                    
                    $('[name="txt_title"]').val(movie.title);
                    $('[name="url_lama"]').val(movie.image);
                    $('[name="url_lama2"]').val(movie.baner1);
                    $('[name="txt_rating"]').val(movie.rating);
                    $('[name="txt_year"]').val(movie.year);
                    $('[name="txt_des"]').val(movie.description);
                    $('[name="txt_review"]').val(movie.review);
                ...
                $('#update_entry').submit(function(e){
                        var sure = confirm("Are You Sure To Update This Post?");
                if (sure) {
                    e.preventDefault();
                    alert('Review Was Updated');


                    Movie.transaction(function(movie){
                        
                        movie = movie    || {};
                        movie.title = $('[name="txt_title"]').val();
                        if ($('[name="link"]').val() == "")
                        {
                        	img=$('[name="url_lama"]').val()
                        }
                        else 
                        {
                        	img=$('[name="link"]').val()
