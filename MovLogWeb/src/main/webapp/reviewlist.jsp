                  ...
                  <div class="table-responsive table--no-card m-b-30">
                    ...
                    <thead>
                        <tr style="text-align: center;">
                            <th onclick="sortTable(0)" style="cursor:hand;cursor:pointer;">Title</th>
                            <th onclick="sortTable(1)" style="cursor:hand;cursor:pointer;">Genre</th>
                            <th onclick="sortTable(2)" style="cursor:hand;cursor:pointer;">Release Date</th>
                            <th onclick="sortTable(3)" style="cursor:hand;cursor:pointer;">Publish Date</th>
                            <th onclick="sortTable(4)" style="cursor:hand;cursor:pointer;">Status</th>
                            <th onclick="sortTable(5)" style="cursor:hand;cursor:pointer;">Rating</th>
                            <th>Cover</th>
                            <th>Delete</th>
                            <th>Update</th>
...
function sortTable(n) {
  ...
  while (switching) {
	...
	var tblMovie = document.getElementById('Table');
	  var databaseRef = firebase.database().ref('Movie').orderByChild('date');
	  var rowIndex = 1;
	  ...
	  databaseRef.once('value', function(snapshot) {
	   ...
	   var cellGenre = row.insertCell(1);
	   var cellReleaseDate = row.insertCell(2);
	   var cellPublishDate = row.insertCell(3);
	   var cellStatus = row.insertCell(4);
	   var cellRating = row.insertCell(5);
       var cellCover = row.insertCell(6);
	   var cellButtons = row.insertCell(7);
       var cellUButtons = row.insertCell(8);

	   cellButtons.innerHTML = "Delete";
	   cellButtons.setAttribute("title", childKey);
	   cellButtons.addEventListener("click", deleteButton);
       cellUButtons.innerHTML = "Update";
       cellUButtons.setAttribute("idF", childKey);
       cellUButtons.addEventListener("click", updateButton);
	   ...
	   cellReleaseDate.appendChild(document.createTextNode(childData.year));
	   cellPublishDate.appendChild(document.createTextNode(childData.date));
	   cellStatus.appendChild(document.createTextNode(childData.status));
	   cellRating.appendChild(document.createTextNode(childData.rating));
       cellCover.outerHTML = "<img src='"+childData.image+"' width='130' height='100'>";
	  ...
	  function deleteButton(e) {
			e.stopPropagation();
			var MovieID = e.target.getAttribute("title");
			var sure = confirm("Are You Sure To Delete This Post?");
		    if (sure) {
			const userRef = firebase.database().ref().child('Movie/' + MovieID).remove();
