                  ...
                  <div class="table-responsive table--no-card m-b-30">
                    ...
                    <thead>
                        <tr style="text-align: center;">
                            ...
                            <th onclick="sortTable(1)" style="cursor:hand;cursor:pointer;">User</th>
                            <th onclick="sortTable(2)" style="cursor:hand;cursor:pointer;">Feedback</th>
                            <th>Delete</th>
  ...
  while (switching) {
	...
	var tblMovie = document.getElementById('Table');
	  ...
	  databaseRef.once('value', function(snapshot) {
	   ...
	   cellUser.appendChild(document.createTextNode(childData.user));
	  ...
	  function deleteButton(e) {
		    ...
		    if (sure) {
			const userRef = firebase.database().ref().child('Feedback/' + MovieID).remove();
