                  ...
                  <div class="table-responsive table--no-card m-b-30">
                    ...
                    <thead>
                        <tr style="text-align: center;">
                            ...
                            <th onclick="sortTable(1)" style="cursor:hand;cursor:pointer;">MovieId</th>
                            <th onclick="sortTable(2)" style="cursor:hand;cursor:pointer;">Rating User</th>
                            <th onclick="sortTable(3)" style="cursor:hand;cursor:pointer;">Comment</th>
                            <th>Delete</th>
...
function sortTable(n) {
  ...
  while (switching) {
	...
	var tblMovie = document.getElementById('Table');
	  var databaseRef = firebase.database().ref('Rating');
	  var rowIndex = 1;
	  ...
	  databaseRef.once('value', function(snapshot) {
	   ...
	   var cellRating = row.insertCell(2);
       var cellComment = row.insertCell(3);
	   var cellButtons = row.insertCell(4);


	   cellButtons.innerHTML = "Delete";
	   cellButtons.setAttribute("userId", childKey);
	   cellButtons.addEventListener("click", deleteButton);
	   cellEmail.appendChild(document.createTextNode(childData.userId));
	   cellMovie.appendChild(document.createTextNode(childData.movieId));
	   cellRating.appendChild(document.createTextNode(childData.ratevalue));
	  ...
	  function deleteButton(e) {
			e.stopPropagation();
			var MovieID = e.target.getAttribute("userId");
			var sure = confirm("Are You Sure To Delete This Comment?");
		    if (sure) {
			const userRef = firebase.database().ref().child('Rating/' + MovieID).remove();
