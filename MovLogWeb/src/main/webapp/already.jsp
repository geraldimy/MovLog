                    ...
                    <div class="post-content-area mb-50">
                        ...
                        <div class="world-catagory-area">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="title">Already Released</li>
                                <li class="nav-item">
...
//                                 }        
        database.ref('Movie').orderByChild('status').equalTo('Already Released').on('child_added', function(data) {
